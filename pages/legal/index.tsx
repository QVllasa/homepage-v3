    ...
    return (
        <>
            <SEOHead
                ...
                description="Impressum und rechtliche Informationen gemäß § 5 TMG für die Website von Qendrim Vllasa, Software Engineer & Cloud Expert."
                keywords={["Impressum", "Rechtliche Hinweise", "TMG", "Datenschutz", "Legal Notice"]}
                noindex={false}
            />
