        ...
        <div className="relative overflow-hidden bg-white transition dark:bg-slate-900 py-16">
            ...
            <div className="relative px-6 lg:px-8">
                <div className="mx-auto max-w-prose text-lg">
                    <h3>
                        <span
                            className="block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Datenschutzerkl&auml;rung</span>
                        <span
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Allgemeine
                            Hinweise</span>
                    </h3>
                ...
                <div className="prose prose-lg prose-blue mx-auto mt-6 text-gray-500 dark:text-slate-300 transition">
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Datenerfassung
                            auf dieser Website</span>
                    </h3>
                    <p className={'font-bold text-xl'}>Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieser
                        Website?</p>
                    <p className="leading-8 text-gray-500 dark:text-slate-300 transition">
                        Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen
                        Kontaktdaten k&ouml;nnen Sie dem Impressum dieser Website entnehmen.
                    </p>

                    <p className={'font-bold text-xl'}>Wie erfassen wir Ihre Daten?</p>
                    <p className="leading-8 text-gray-500 dark:text-slate-300 transition">
                    ...
                    <p className={'font-bold text-xl'}>Wof&uuml;r nutzen wir Ihre Daten?</p>
                    <p className="leading-8 text-gray-500 dark:text-slate-300 transition">
                    ...
                    <p className={'font-bold text-xl'}>Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</p>
                    <p className="leading-8 text-gray-500 dark:text-slate-300 transition">
                    ...
                    <p>Au&szlig;erdem haben Sie das Recht, unter bestimmten Umst&auml;nden die Einschr&auml;nkung
                        ...
                        der Datenschutzerkl&auml;rung unter &bdquo;Recht auf Einschr&auml;nkung der Verarbeitung&ldquo;.
                    </p>

                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Analyse-Tools
                            und Tools von Drittanbietern</span>
                    </h3>
                    <p className="leading-8 text-gray-500 dark:text-slate-300 transition">
                        <span>Beim Besuch dieser Website kann Ihr Surf-Verhalten statistisch ausgewertet werden. Das
                            ...
                            zur&uuml;ckverfolgt
                            werden.</span>
                        <span>Sie k&ouml;nnen dieser Analyse widersprechen oder sie durch die Nichtbenutzung bestimmter
                            Tools verhindern. Detaillierte Informationen zu diesen Tools und &uuml;ber Ihre
                            Widerspruchsm&ouml;glichkeiten finden Sie in der folgenden Datenschutzerkl&auml;rung.</span>
                    </p>

                    <h3>
                        <span
                            className="mt-24 block text-center text-3xl font-bold leading-8 tracking-tight text-slate-900 dark:text-slate-100 sm:text-4xl">
                            2. Allgemeine Hinweise und Pflichtinformationen
                        </span>
                    </h3>
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Datenschutz</span>
                    </h3>
                    <p className="leading-8 text-gray-500 dark:text-slate-300 transition">
                        <span>Die Betreiber dieser Seiten nehmen den Schutz Ihrer pers&ouml;nlichen Daten sehr ernst.
                            Wir
                            behandeln Ihre personenbezogenen Daten vertraulich und entsprechend der gesetzlichen
                            Datenschutzvorschriften sowie dieser Datenschutzerkl&auml;rung.</span>
                        <span>Wenn Sie diese Website benutzen, werden verschiedene personenbezogene Daten erhoben.
                        ...
                        <span>Wir weisen darauf hin, dass die Daten&uuml;bertragung im Internet (z.&nbsp;B. bei der
                            Kommunikation per E-Mail) Sicherheitsl&uuml;cken aufweisen kann. Ein l&uuml;ckenloser Schutz
                            der Daten vor dem Zugriff durch Dritte ist nicht m&ouml;glich.</span>
                    </p>

                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Hinweis
                            zur verantwortlichen Stelle</span>
                    </h3>
                    <p className="leading-8 text-gray-500 dark:text-slate-300 transition">
                        <span>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</span>
                        <span>Qendrim Vllasa<br/>
                            Lohstrasse 7<br/>
                            8280 Kreuzlingen</span>

                        <span>Telefon: +49 (0) 15156424831<br/>
                            E-Mail: qendrim.vllasa@gmail.com</span>
                        <span>Verantwortliche Stelle ist die nat&uuml;rliche oder juristische Person, die allein oder
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Widerruf
                            Ihrer Einwilligung zur Datenverarbeitung</span>
                    </h3>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Widerspruchsrecht
                            gegen die Datenerhebung in besonderen F&auml;llen sowie gegen
                            Direktwerbung (Art. 21 DSGVO)</span>
                    </h3>
                    <p>WENN DIE DATENVERARBEITUNG AUF GRUNDLAGE VON ART. 6 ABS. 1 LIT. E ODER F DSGVO ERFOLGT, HABEN
                        ...
                        DIREKTWERBUNG ZU BETREIBEN, SO HABEN SIE
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Beschwerderecht
                            bei der zust&auml;ndigen Aufsichtsbeh&ouml;rde</span>
                    </h3>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Recht
                            auf Daten&uuml;bertragbarkeit</span>
                    </h3>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">SSL-
                            bzw. TLS-Verschl&uuml;sselung</span>
                    </h3>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Auskunft,
                            L&ouml;schung und Berichtigung</span>
                    </h3>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Recht
                            auf Einschr&auml;nkung der Verarbeitung</span>
                    </h3>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Widerspruch
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Cookies</span>
                    </h3>
                    ...
                    <p>Die meisten der von uns verwendeten Cookies sind so genannte &bdquo;Session-Cookies&ldquo;.
                    ...
                    <p>Soweit andere Cookies (z.&nbsp;B. Cookies zur Analyse Ihres Surfverhaltens) gespeichert
                        werden, werden diese in dieser Datenschutzerkl&auml;rung gesondert behandelt.</p>


                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Kontaktformular</span>
                    </h3>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Anfrage
                            per E-Mail, Telefon oder Telefax</span>
                    </h3>
                    ...
                    <p>Die Verarbeitung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO, sofern
                        ...
                        der effektiven Bearbeitung der an uns gerichteten Anfragen haben.</p>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Kommentarfunktion
                            auf dieser Website</span>
                    </h3>
                    ...
                    <p><span className={'font-bold'}>Speicherung der IP-Adresse</span></p>
                    <p>Unsere Kommentarfunktion speichert die IP-Adressen der Nutzer, die Kommentare verfassen. Da
                        ...
                        den Verfasser vorgehen zu k&ouml;nnen.</p>
                    <p><span className={'font-bold'}>Abonnieren von Kommentaren</span></p>
                    <p>Als Nutzer der Seite k&ouml;nnen Sie nach einer Anmeldung Kommentare abonnieren. Sie erhalten
                        ...
                        die jedoch bei uns.</p>
                    <p><span className={'font-bold'}>Speicherdauer der Kommentare</span></p>
                    <p>Die Kommentare und die damit verbundenen Daten (z.&nbsp;B. IP-Adresse) werden gespeichert und
                        verbleiben auf dieser Website, bis der kommentierte Inhalt vollst&auml;ndig gel&ouml;scht
                        wurde oder die Kommentare aus rechtlichen Gr&uuml;nden gel&ouml;scht werden m&uuml;ssen
                        (z.&nbsp;B.
                        beleidigende Kommentare).</p>
                    <p><span className={'font-bold'}>Rechtsgrundlage</span></p>
                    <p>Die Speicherung der Kommentare erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a
                        DSGVO). Sie k&ouml;nnen eine von Ihnen erteilte Einwilligung jederzeit widerrufen. Dazu
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Newsletterdaten</span>
                    </h3>
                    <p>Wenn Sie den auf der Website angebotenen Newsletter beziehen m&ouml;chten, ben&ouml;tigen wir
                    ...
                    <p>Nach Ihrer Austragung aus der Newsletterverteilerliste wird Ihre E-Mail-Adresse bei uns bzw.
                        ...
                        Blacklist ist zeitlich nicht befristet. <span className={'font-bold'}>Sie k&ouml;nnen der
                            Speicherung
                            widersprechen, sofern Ihre Interessen unser berechtigtes Interesse
                            &uuml;berwiegen.</span></p>
                    ...
                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Vimeo</span>
                    </h3>
                    <p>Diese Website nutzt Plugins des Videoportals Vimeo. Anbieter ist die Vimeo Inc., 555 West
                    ...
                    <p>Wenn Sie eine unserer mit einem Vimeo-Plugin ausgestatteten Seiten besuchen, wird eine
                        ...
                        &uuml;bermittelt.</p>
                    <p>Wenn Sie in Ihrem Vimeo-Account eingeloggt sind, erm&ouml;glichen Sie Vimeo, Ihr
                        Surfverhalten direkt Ihrem pers&ouml;nlichen Profil zuzuordnen. Dies k&ouml;nnen Sie
                        verhindern, indem Sie sich aus Ihrem Vimeo-Account ausloggen.</p>
                    <p>Die Nutzung von Vimeo erfolgt im Interesse einer ansprechenden Darstellung unserer
                        ...
                        DSGVO dar. Sofern eine entsprechende Einwilligung abgefragt wurde (z. B. eine Einwilligung
                        zur Speicherung von Cookies), erfolgt die Verarbeitung ausschlie&szlig;lich auf Grundlage
                        von Art. 6 Abs. 1 lit. a DSGVO; die Einwilligung ist jederzeit widerrufbar.</p>
                    <p>Weitere Informationen zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerkl&auml;rung
                        von Vimeo unter: <a href="https://vimeo.com/privacy" target="_blank"
                                            rel="noopener noreferrer">https://vimeo.com/privacy</a>.</p>


                    <h3>
                        <span
                            className="mt-24 block text-center text-lg font-semibold text-blue-600 dark:text-yellow-500 transition">Google
                            Web Fonts</span>
                    </h3>
                    ...
                    <p>Zu diesem Zweck muss der von Ihnen verwendete Browser Verbindung zu den Servern von Google
                        ...
                        diese Website aufgerufen wurde. Die Nutzung von Google Web Fonts erfolgt im Interesse einer
                    ...
                    <p>Wenn Ihr Browser Web Fonts nicht unterst&uuml;tzt, wird eine Standardschrift von Ihrem
                        Computer genutzt.</p>
                    <p>Weitere Informationen zu Google Web Fonts finden Sie unter <br/> <a
