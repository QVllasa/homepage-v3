        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
                ...
                <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 pt-4 sm:pt-6 lg:pt-8 pb-8 sm:pb-12 lg:pb-16">                <div className="space-y-4 sm:space-y-6 lg:space-y-8">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-600 p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 lg:mb-8">
                                ...
                                {data.previewLink ? (
                                    ...
                                    <div className="relative group w-full sm:w-auto">
                                        ...
                                        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-sm px-3 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
                                            {t('projects.sections.demoUnavailable')}
                                        </div>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                {data.client && (
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{t('projects.sections.client')}</p>
                                ...
                                {data.status && (
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{t('projects.sections.status')}</p>
                            ...
                            {data.stats && (
                                <div className="mt-6 sm:mt-8">
                                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">{t('projects.sections.stats')}</h3>
                    ...
                    {/* Description */}
                        <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-600 p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 lg:mb-8">
                            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">{t('projects.sections.description')}</h2>
                        ...
                        {data.techStack && (
                            <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-600 p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 lg:mb-8">
                                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 flex items-center">
                                    ...
                                    <span className="text-base sm:text-xl lg:text-2xl">{t('projects.sections.techStack')}</span>
                                </h2>
                        ...
                        {data.skills && (
                            <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-600 p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 lg:mb-8">
                                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 flex items-center">
                                    ...
                                    <span className="text-base sm:text-xl lg:text-2xl">{t('projects.sections.skills')}</span>
                                </h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        {data.keys && (
                            <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-600 p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6 lg:mb-8">
                                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 flex items-center">
                                    ...
                                    <span className="text-base sm:text-xl lg:text-2xl">{t('projects.sections.mainFeatures')}</span>
                                </h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            {data.challenges && (
                                <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-600 p-4 sm:p-6 lg:p-8">
                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 flex items-center">
                                        ...
                                        <span className="text-base sm:text-xl lg:text-2xl">{t('projects.sections.challenges')}</span>
                                    </h2>
                            ...
                            {data.learnings && (
                                <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl border border-gray-200 dark:border-slate-600 p-4 sm:p-6 lg:p-8">
                                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 flex items-center">
                                        ...
                                        <span className="text-base sm:text-xl lg:text-2xl">{t('projects.sections.learnings')}</span>
                                    </h2>
                                    <div className="space-y-4 sm:space-y-6">
