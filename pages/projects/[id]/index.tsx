                    ...
                    <div
                        ...
                        <Link target="_blank" href={data.previewLink ?? ''}
                            ...
                            <button
                                ...
                                type="button"
                                className="relative mx-auto disabled:bg-gray-300  block  rounded-md border border-transparent bg-blue-600 px-5 py-3 text-base font-medium text-white  hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-500 sm:px-10"
                            >
                                Live Preview
                            </button>
                        </Link>
                    ...
                    <div className="mt-10 space-y-10">
                        {data.keys.map((item, index) => (
                            <div key={index} className="relative">
                                <dt>
                                    <div
                                        className="absolute flex h-12 w-12 items-center justify-center rounded-xl text-blue-600">
