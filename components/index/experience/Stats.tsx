                        ...
                        <div className="mx-auto max-w-3xl">
                            <dl className="rounded-lg border transition dark:border-slate-700 sm:grid sm:grid-cols-3">
                                <div
                                    ...
                                    <dt className="order-2 mt-2 text-lg font-medium transition leading-6 text-gray-500 dark:text-slate-200">
                                        {t('experience.stats.years')}
                                    </dt>
                                ...
                                <div
                                    ...
                                    <dt className="order-2 mt-2 text-lg transition font-medium leading-6 text-gray-500 dark:text-slate-200">
                                        {t('experience.stats.languages')}
                                    </dt>
