                        ...
                        <div className="mx-auto max-w-3xl">
                            <dl className="rounded-lg border transition dark:border-slate-700 sm:grid sm:grid-cols-3">
                                <div
                                    ...
                                    <dd className="order-1 text-5xl font-bold tracking-tight transition text-blue-600 dark:text-yellow-500">4+</dd>
                                </div>
                                <div
                                    ...
                                    <dd className="order-1 text-5xl font-bold transition tracking-tight text-blue-600 dark:text-yellow-500">8+</dd>
                                </div>
                                <div
