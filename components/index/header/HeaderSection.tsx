            ...
            <div
                ...
                <div>
                    <div
                        ...
                        <p className="block transition font-medium text-blue-600 transition dark:text-yellow-500 xl:inline">Hi,
                            I am</p>{' '}
                        <br/>
                        <p
                            className="block transition font-bold xl:inline transition dark:text-slate-100">Qendrim
                            Vllasa</p>
                    </div>
                    <div
